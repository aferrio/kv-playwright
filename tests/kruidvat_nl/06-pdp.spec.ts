...
test('should display Voltaren product page correctly', async ({ page }) => {
  ...
  const productImage = page.locator('img.preview.selected[src*="/temp-prd-front-228226-1_600x600/temp-prd-front-228226-1-600x600.jpg"][alt="Productvoorbeeldafbeelding weergeven 1"]');
